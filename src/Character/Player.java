...
public class Player extends Character implements KeyboardHandler {
    ...
    private MapFactory myFactory = new MapFactory();
    ...
    public boolean Collision() {
        if ((hitBox.getX() < wall1.getX() + wall1.getWidth()
                ...
                && hitBox.getY() + hitBox.getHeight() > wall6.getY())|| (hitBox.getX() < exit.getX() + exit.getWidth()
                && hitBox.getX() + hitBox.getWidth() > exit.getX()
                && hitBox.getY() < exit.getY() + exit.getHeight()
                && hitBox.getY() + hitBox.getHeight() > exit.getY())) {
    ...
    public Boolean doorsCollision() {
        ...
        if ((hitBox.getX() < doorOne.getX() + doorOne.getWidth()
                && hitBox.getX() + hitBox.getWidth() > doorOne.getX()
                && hitBox.getY() < doorOne.getY() + doorOne.getHeight()
                && hitBox.getHeight() + hitBox.getY() > doorOne.getY())) {
            ...
            if (this.passTwo) {
                System.out.println("resposta certa 2");
                return false;
            }

            doorDialogue.init();
            return true;
        } else if ((hitBox.getX() < doorThree.getX() + doorThree.getWidth()
                && hitBox.getX() + hitBox.getWidth() > doorThree.getX()
                && hitBox.getY() < doorThree.getY() + doorThree.getHeight()
                && hitBox.getHeight() + hitBox.getY() > doorThree.getY())) {
            if (this.passThree) {
                System.out.println("resposta certa 3");
                return false;
            }
            ...
            return true;
        }else if ((hitBox.getX() < hologram.getX() + hologram.getWidth()
            && hitBox.getX() + hitBox.getWidth() > hologram.getX()
            && hitBox.getY() < hologram.getY() + hologram.getHeight()
            && hitBox.getHeight() + hitBox.getY() > hologram.getY())){
        System.out.println("book2");
        ...
        if (movementStart) {
            ...
            switch (keyboardEvent.getKey()) {
                case KeyboardEvent.KEY_D:
                    ...
                    System.out.println("wall height " + wall6.getHeight());
                    System.out.println("wall width " + wall6.getWidth());
                    System.out.println("x: " + hitBox.getX());
                    System.out.println("y: " + hitBox.getY());
                    ...
                    if (objectsCollision()) {
                        ...
                        picture1.translate(-10, 0);
                        picture2.translate(-10, 0);
                        picture3.translate(-10, 0);
                        picture4.translate(-10, 0);
                ...
                case KeyboardEvent.KEY_W:
                    ...
                    if (objectsCollision()) {
                        ...
                        picture2.translate(0, 10);
                        picture3.translate(0, 10);
                        picture4.translate(0, 10);
